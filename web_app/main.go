...
import (
	...
	"web_app.com/webapp/routes"

	"github.com/spf13/viper"

	"go.uber.org/zap"

	"web_app.com/webapp/dao/mysql"
	"web_app.com/webapp/dao/redis"

	"web_app.com/webapp/logger"

	"web_app.com/webapp/settings"
)

// Go Web开发通用脚手架
func main() {
	// 1、加载配置
	// settings文件夹，使用viper管理配置文件
